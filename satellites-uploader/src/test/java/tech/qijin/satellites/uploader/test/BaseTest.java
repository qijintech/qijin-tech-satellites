package tech.qijin.satellites.uploader.test;
...
import tech.qijin.satellites.uploader.config.SatellitesUploaderAutoConfiguration;
...
@SpringBootTest(classes = SatellitesUploaderAutoConfiguration.class)
@Transactional
