package tech.qijin.satellites.gim.test;
...
import tech.qijin.satellites.gim.config.SatellitesGIMAutoConfiguration;
...
@SpringBootTest(classes = SatellitesGIMAutoConfiguration.class)
@Transactional
