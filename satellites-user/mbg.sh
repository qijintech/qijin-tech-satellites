...
pack=tech.qijin.satellites.user
...
mapper_path=src/main/java/$pack_path/db/mapper
dao_path=src/main/java/$pack_path/db/dao
model_path=src/main/java/$pack_path/db/model
