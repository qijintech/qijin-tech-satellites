package tech.qijin.satellites.address.test;
...
import tech.qijin.satellites.rank.config.SatellitesRankAutoConfiguration;
...
@SpringBootTest(classes = SatellitesRankAutoConfiguration.class)
@Transactional
