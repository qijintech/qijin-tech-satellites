...
import tech.qijin.satellites.comments.db.mapper.CmCommentMapper;
import tech.qijin.satellites.comments.db.mapper.CmCommentSqlProvider;
...
public interface CmCommentDao extends CmCommentMapper {
	...
	class SqlProvider {
		...
		private String genSql(List<CmComment> records) {
