...
import tech.qijin.satellites.item.db.model.ItemModelExample.Criteria;
import tech.qijin.satellites.item.db.model.ItemModelExample.Criterion;

public class ItemModelSqlProvider {

    public String countByExample(ItemModelExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("item_model");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ItemModelExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("item_model");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ItemModel record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("item_model");
    ...
    public String selectByExample(ItemModelExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ItemModel record = (ItemModel) parameter.get("record");
        ItemModelExample example = (ItemModelExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("item_model");
    ...
    public String updateByPrimaryKeySelective(ItemModel record) {
        SQL sql = new SQL();
        sql.UPDATE("item_model");
    ...
    protected void applyWhere(SQL sql, ItemModelExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
