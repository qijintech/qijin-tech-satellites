...
public class ItemTagSqlProvider {
    ...
    public String countByExample(ItemTagExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("item_tag");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(ItemTagExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("item_tag");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(ItemTag record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("item_tag");
    ...
    public String selectByExample(ItemTagExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ItemTag record = (ItemTag) parameter.get("record");
        ItemTagExample example = (ItemTagExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ItemTag record) {
        SQL sql = new SQL();
        sql.UPDATE("item_tag");
    ...
    protected void applyWhere(SQL sql, ItemTagExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
