CREATE TABLE `order_item` (
  ...
  `sku_price` decimal(12,2) DEFAULT '99999.00' COMMENT '商品销售价（优惠前）',
  `sku_order_price` decimal(12,2) DEFAULT '99999.00' COMMENT '商品（优惠后）价格',
  `item_reduced_amount` decimal(12,2) DEFAULT '0.00' COMMENT '商品优惠金额',
